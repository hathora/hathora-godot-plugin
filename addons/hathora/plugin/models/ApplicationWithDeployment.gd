...
# ApplicationWithDeployment Model
...
# Required: False
# isArray: false
@export var deployment: Deployment:
	set(value):
		__deployment__was__set = true
		deployment = value
var __deployment__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__deployment__was__set:
		bzz_dictionary["deployment"] = self.deployment
...
static func bzz_denormalize_single(from_dict: Dictionary):
	var me := new()
	if from_dict.has("deletedBy") && from_dict["deletedBy"] != null:
	...
	if from_dict.has("deployment"):
		me.deployment = Deployment.bzz_denormalize_single(from_dict["deployment"])
	return me
